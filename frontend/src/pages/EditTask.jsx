...
const EditTask = () => {
  ...
  const initialValues = {
    name: 'Nom de la tâche existante',
    description: 'Ceci est une description exemple.',
    startDate: '2025-03-01',
    endDate: '2025-03-30',
    resources: 'Ressource A, Ressource B',
  };

  const handleSubmit = (values) => {
    console.log('Tâche mise à jour :', values);
    navigate('/tasks');
  };

  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold text-[#003f6b] mb-6">Modifier une Tâche</h1>
        ...
        {({ errors, touched }) => (
          <Form className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="mb-4">
              ...
              <Field type="text" id="resources" name="resources" className="w-full p-3 mt-2 border rounded-lg border-[#dc4048] focus:outline-none focus:ring-2 focus:ring-[#dc4048]" />
